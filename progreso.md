...
| --- | --- | --- |
| S7-01 Quitar los resultados de los puntos | Completada | Las tarjetas de resultados ya no revelan valores solo por calcular el RUT. Quedan con `--` y se rellenan cuando el campo de defensa asociado se valida correctamente. Tambien se retiro el cuadro de resumen de esa zona. |
| S7-02 Quitar los nombres de los puntos en el grafico | Completada | El canvas de conicas ya no dibuja etiquetas fijas sobre puntos y lineas calculadas. Los nombres solo aparecen como ayuda al pasar el cursor sobre puntos ingresados y validados por defensa. |
| S7-03 Redisenar apartado de Desarrollo Matematico | Completada | El desarrollo matematico se reordeno en tarjetas tipo pizarron/cuaderno: los coeficientes quedan dentro de un mismo punto, los ajustes de rubrica se agrupan y los calculos usan KaTeX en lineas separadas. |
